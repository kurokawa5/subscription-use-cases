  ...
  public static void main(String[] args) {
    ...
    get(
      ...
      (request, response) -> {
        ...
        List<String> lookupKeys = Arrays.asList(
          "entry_plan", "ec_plan_onemonth", "sns_plan_onemonth", "ec_sns_plan_onemonth", "community_plan_onemonth", "ec_sns_community_plan_onemonth",
        ...
        for (String lookupKey : lookupKeys) {
          PriceListParams params = PriceListParams.builder().addLookupKeys(lookupKey).build();
          PriceCollection priceCollection = Price.list(params);
          prices.addAll(priceCollection.getData());
        }
        /*
        PriceListParams params = PriceListParams
        .builder()
        //.setLimit(Long.valueOf(100))
          //.addLookupKeys("sample_basic")
          //.addLookupKeys("sample_premium")
          // 1 month plan
          .addAllLookupKeys(Arrays.asList("entry_plan", "ec_plan_onemonth", "sns_plan_onemonth", "ec_sns_plan_onemonth", "community_plan_onemonth", "ec_sns_community_plan_onemonth"))
          // 6 months plan
          .addAllLookupKeys(Arrays.asList("entry_plan_sixmonth", "ec_plan_sixmonth", "sns_plan_sixmonth", "ec_sns_plan_sixmonth", "community_plan_sixmonth"))
          // 1 yaer plan
          .addAllLookupKeys(Arrays.asList("entry_plan_oneyear", "ec_plan_oneyear", "sns_plan_oneyear", "ec_sns_plan_oneyear", "ec_sns_plan_oneyear", "community_plan_oneyear"))
          .build();
    ...
    post(
      ...
      (request, response) -> {
        ...
        // Get the coupon code from the request body sent by the frontend
        String couponCode = postBody.getCouponCode();
        System.out.print(couponCode);
    ...
    post("/apply-promotion-code", (request, response) -> {
      response.type("application/json");

      String subscriptionId = request.queryParams("subscriptionId");
      String promotionCode = request.queryParams("promotionCode");

      Subscription subscription = Subscription.retrieve(subscriptionId);
      SubscriptionUpdateParams params = SubscriptionUpdateParams.builder()
              .setCoupon(promotionCode)
              .build();
      subscription.update(params);
      Map<String, Object> responseData = new HashMap<>();
      responseData.put("subscription", subscription);
